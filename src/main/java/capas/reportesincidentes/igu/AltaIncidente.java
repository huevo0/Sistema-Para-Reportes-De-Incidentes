...
public class AltaIncidente extends javax.swing.JFrame {
    ...
    public AltaIncidente(Controladora control, int idTecnico, int idIncidente) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ALTA DE INCIDENTES");
        ...
        txtFechaRes.setEditable(false);
        jScrollPane7.setViewportView(txtFechaRes);

        txtColchonHora.setEditable(false);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtFechaAlta.setText(LocalDateTime.now().format(formatoFecha));
        
        List<Cliente>listaClientes = control.traerClientes();
        List<Servicio>servCliente = new ArrayList<>();
        for (Cliente listaCliente : listaClientes) {
                cmbCliente.addItem(listaCliente.getRazonSocial());
        }
    ...
    private void btnBuscarTecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarTecActionPerformed
        ...
        if (tablaServicios.getRowCount() > 0) {
            ...
            if (tablaServicios.getSelectedRow() != -1) {
                ...
                String tipoServ = String.valueOf(tablaServicios.getValueAt(tablaServicios.getSelectedRow(), 2));
                cargarDificultad(tipoServ);
                DateTimeFormatter formatoFecha = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm");
                long colchon = Long.parseLong(txtColchonHora.getText());
                LocalDateTime resolucion = LocalDateTime.now().plusHours(colchon);
                txtFechaRes.setText(resolucion.format(formatoFecha));
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        tablaTecnicos.setModel(tableModel);
        tableModel.setRowCount(0);
        txtDescripcion.setText("");
        txtColchonHora.setText("");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.crearIncidente(cliente,cuit , idServicio, idTecnico, descripcion, dificultad, tipoProblema, estado, fechaAlta, fechaReso, colchonHoras);
        MesaDeAyuda mesaDeAyuda = new MesaDeAyuda(control, idTecnico,idIncidente);
