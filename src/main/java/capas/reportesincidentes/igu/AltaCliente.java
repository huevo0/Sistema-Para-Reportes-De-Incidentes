...
public class AltaCliente extends javax.swing.JFrame {
    ...
    public AltaCliente(Controladora control) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(!txtRazonSocial.getText().isEmpty() && !txtCuit.getText().isEmpty() && !txtTelefono.getText().isEmpty() && !txtEmail.getText().isEmpty() && cmbServicio.getSelectedIndex()!=0){
            ...
            control.guardarCliente(razonSocial, cuit, telefono, email, servicio);
            mostrarMensaje("Cliente guardado correctamente", "info", "Alta Exitosa");

            btnLimpiarActionPerformed(evt);
        } else {    mostrarMensaje("Por favor verifique que los campos no esten vacios", "Error", "Error al Guardar");
            }
