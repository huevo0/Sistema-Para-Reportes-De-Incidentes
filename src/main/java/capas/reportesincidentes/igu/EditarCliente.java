...
public class EditarCliente extends javax.swing.JFrame {
    ...
    int IdCLiente;
    public EditarCliente(Controladora control , int idCliente) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        List<Servicio>servDelCliente = cliente.getServicios();
        for (Servicio servicio : servDelCliente) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
          ...
          control.editarCliente(IdCLiente, razonSocial, cuit, telefono, email);
