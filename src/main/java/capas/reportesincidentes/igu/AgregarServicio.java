...
public class AgregarServicio extends javax.swing.JFrame {
    ...
    int idCliente;
    int idServicio;
    public AgregarServicio(Controladora control, int idCliente) {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtRazonSocial, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtCuit, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jLabel2.setText("AGREGAR SERVICIO AL CLIENTE");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Cliente cliente = control.traerUnCliente(idCliente);
        ...
        while(iterador.hasNext()){
            ...
            for (Servicio servicio : servCliente) {
                if(servicio.getId()==serv.getId()){
                    iterador.remove();
                }
            }
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(cmbServicio.getSelectedIndex()!=0){
            ...
            control.agregarUnServicio(idCliente, servicio);
            mostrarMensaje("Cliente guardado correctamente", "info", "Edicion Exitosa");
            this.dispose();
        } else {    
                    mostrarMensaje("Por favor verifique que los campos no esten vacios", "Error", "Error al Guardar");
            }
