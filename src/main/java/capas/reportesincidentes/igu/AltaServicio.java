...
public class AltaServicio extends javax.swing.JFrame {
    ...
    int idCliente;
    public AltaServicio(Controladora control) {
    ...
    private void initComponents() {
        ...
        cmbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Sistema Operativo", "Aplicaciones" }));
        ...
        jLabel2.setText("ALTA DE SERVICIO");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(!txtNombre.getText().isEmpty() && cmbTipo.getSelectedIndex()!=0){
            ...
            control.guardarServicio(nombre, descripcion);
            AreaComercial areaComercial = new AreaComercial(this.control , this.idCliente);
            areaComercial.mostrarMensaje("El Servicio se creo correctamente", "info", "Guardado Exitoso");
            btnLimpiarActionPerformed(evt);
        } else {    GestionServicios gestionServicios = new GestionServicios(control);
                    gestionServicios.mostrarMensaje("Por favor verifique que los campos no esten vacios", "Error", "Error al Guardar");
        }
