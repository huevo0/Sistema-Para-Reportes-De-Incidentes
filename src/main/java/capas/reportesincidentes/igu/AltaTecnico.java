...
public class AltaTecnico extends javax.swing.JFrame {
    ...
    int idTecnico;
    public AltaTecnico(Controladora control) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ALTA DE TECNICO");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(!txtNombre.getText().isEmpty() && cmbServicio.getSelectedIndex()!=0){
            String nombre = txtNombre.getText();
            String especialidad = (String) cmbServicio.getSelectedItem();

            control.crearTecnico(nombre, especialidad);
            ...
            btnLimpiarActionPerformed(evt);
                    ...
                    recursosHumanos.mostrarMensaje("Por favor verifique que los campos no esten vacios", "Error", "Error al Guardar");
            }
