...
public class QuitarEspecialidad extends javax.swing.JFrame {
    Controladora control;
    int idTecnico;
    public QuitarEspecialidad(Controladora control, int idTecnico) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("QUITAR ESPECIALIDAD DE TECNICO");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if (listaServicios!=null){
           for (Servicio espec : listaEspec) {
                cmbServicio.addItem(espec.getNombre());    
            }
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(cmbServicio.getSelectedIndex()!=0){  
            ...
            control.QuitarEspecialidadTecnico(idTecnico, especialidad);

            
            recursosHumanos.mostrarMensaje("Tecnico guardado correctamente", "info", "Cambio Exitoso");
            this.dispose();
