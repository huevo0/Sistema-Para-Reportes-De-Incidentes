...
public class AgregarEspecialidad extends javax.swing.JFrame {
    ...
    int idTecnico;
    public AgregarEspecialidad(Controladora control, int idTecnico) {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cmbServicio, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel2.setText("AGREGAR ESPECIALIDAD DE TECNICO");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        List<Servicio>listaEspec = tecnico.getEspecialidad();
        List<Servicio>listaServicios = control.traerServicios();
        Iterator<Servicio> iterador = listaServicios.iterator();
        
        while(iterador.hasNext()){
            Servicio serv = iterador.next();
            for (Servicio espec : listaEspec) {
                if(espec.getId()==serv.getId()){
                    iterador.remove();
                }
            }
        }
        for (Servicio listaServicio : listaServicios) {
            cmbServicio.addItem(listaServicio.getNombre());
        }
    
    }//GEN-LAST:event_formWindowOpened

    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        RecursosHumanos recursosHumanos = new RecursosHumanos(control, idTecnico);
        if(cmbServicio.getSelectedIndex()!=0){ 
            String especialidad = (String) cmbServicio.getSelectedItem();

            control.agregarEspecialidadTecnico(idTecnico, especialidad);

            
            recursosHumanos.mostrarMensaje("Tecnico guardado correctamente", "info", "Alta Exitosa");
            this.dispose();
        } else {  recursosHumanos.mostrarMensaje("Por favor verifique que los campos no esten vacios", "Error", "Error al Guardar");
            }
